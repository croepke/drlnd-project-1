...
2. Place the zip-file in the root of this GitHub repository, and unzip (or decompress) the file.
...
To train the agent execute all but the last cell in `Navigation-DQN.ipynb`! The final agent's weights can be found in `dqn-model.pth`. To watch the trained agent interact with the environment, execute the last cell only.
